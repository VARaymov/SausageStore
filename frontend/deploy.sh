...
curl -u ${NEXUS_REPO_USER}:${NEXUS_REPO_PASS} -o sausage-store-frontend-${VERSION}.tar.gz ${NEXUS_REPO_URL_BACKEND}/sausage-store-front/sausage-store/${VERSION}/sausage-store-${VERSION}.tar.gz
ls -la
